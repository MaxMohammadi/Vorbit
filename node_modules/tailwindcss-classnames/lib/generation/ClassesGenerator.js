...
var all_1 = require("./default-classes/all");
var Transforms_1 = require("./default-classes/Transforms");
    ...
    function ClassesGenerator(tailwindConfig) {
        ...
        this.generate = function () {
            var allTemplates = Object.keys(_this.allGeneratedClasses).map(function (classGroup) {
                return new ClassesGroupTemplateGenerator_1.ClassesGroupTemplateGenerator(
        ...
        this.layout = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.Layout), { objectPosition: Object.keys(_this.theme.objectPosition).map(function (x) { return 'object-' + x; }), topRightBottomLeft: Object.keys(_this.theme.inset).flatMap(function (insetValue) {
        ...
        this.backgrounds = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.Backgrounds), { backgroundOpacity: _this.getGeneratedClassesWithOpacities().backgroundOpacities, backgroundColor: _this.getGeneratedClassesWithColors('bg'), backgroundPosition: Object.keys(_this.theme.backgroundPosition).map(function (x) { return 'bg-' + x; }), backgroundSize: Object.keys(_this.theme.backgroundSize).map(function (x) { return 'bg-' + x; }) });
        };
        this.borders = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.Borders), { borderColor: _this.getGeneratedClassesWithColors('border'), borderOpacity: _this.getGeneratedClassesWithOpacities().borderOpacities, borderRadius: Object.keys(_this.theme.borderRadius).flatMap(function (radius) {
                ...
                divideWidth: Object.keys(lodash_1.default.isEmpty(_this.theme.divideWidth)
        ...
        this.transforms = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.Transforms), { scale: ['', 'x-', 'y-'].flatMap(function (x) {
                ...
                translate: ['translate-x', '-translate-x', 'translate-y', '-translate-y'].flatMap(function (x) {
                    return Object.keys(lodash_1.default.isEmpty(_this.theme.translate)
                        ? tslib_1.__assign(tslib_1.__assign({}, _this.theme.spacing), { full: '100%', '1/2': '50%' }) : _this.theme.translate).map(function (value) { return x + '-' + value; });
        ...
        this.interactivity = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.Interactivity), { cursor: Object.keys(_this.theme.cursor).map(function (x) { return 'cursor-' + x; }) });
        };
        this.SVG = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.SVG), { fill: Object.keys(_this.theme.fill).map(function (value) { return 'fill-' + value; }), stroke: Object.keys(_this.theme.stroke).map(function (value) { return 'stroke-' + value; }), strokeWidth: Object.keys(_this.theme.strokeWidth).map(function (value) { return 'stroke-' + value; }) });
        };
        this.accessibility = function () {
            return all_1.AllClasses.Accessibility;
        };
        this.flexBox = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.FlexBox), { flexGrow: Object.keys(_this.theme.flexGrow).map(function (value) { return 'flex-grow' + (value === 'default' ? '' : "-" + value); }), flexShrink: Object.keys(_this.theme.flexShrink).map(function (value) { return 'flex-shrink' + (value === 'default' ? '' : "-" + value); }), order: Object.keys(_this.theme.order).map(function (value) { return "order-" + value; }) });
        };
        this.grid = function () {
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.Grid), { gridTemplateColumns: Object.keys(_this.theme.gridTemplateColumns).map(function (value) { return "grid-cols-" + value; }), gridColumn: Object.keys(_this.theme.gridColumn).map(function (value) { return "col-" + value; }), gridColumnStart: Object.keys(_this.theme.gridColumnStart).map(function (value) { return "col-start-" + value; }), gridColumnEnd: Object.keys(_this.theme.gridColumnEnd).map(function (value) { return "col-end-" + value; }), gridTemplateRows: Object.keys(_this.theme.gridTemplateRows).map(function (value) { return "grid-rows-" + value; }), gridRow: Object.keys(_this.theme.gridRow).map(function (value) { return "row-" + value; }), gridRowStart: Object.keys(_this.theme.gridRowStart).map(function (value) { return "row-start-" + value; }), gridRowEnd: Object.keys(_this.theme.gridRowEnd).map(function (value) { return "row-end-" + value; }), gridGap: ['gap-', 'row-gap-', 'col-gap-'].flatMap(function (x) {
                    // grid gap inherits its values from theme.spacing by default, but theme.gap overrides it.
                    return Object.keys(lodash_1.default.isEmpty(_this.theme.gap)
                        ? _this.theme.spacing
        ...
        this.sizing = function () {
            ...
            return tslib_1.__assign(tslib_1.__assign({}, all_1.AllClasses.Sizing), { 
        ...
        this.getGeneratedClassesWithOpacities = function () {
            ...
            var getOpacity = function (themePropertyName, outputNamePrefix) {
                var generatedOpacities = utils_1.generateOpacities(allOpacities, _this.theme, themePropertyName);
        ...
        this.getGeneratedPseudoClasses = function () {
            ...
            classesCategories.map(function (k, i) {
                ...
                switch (key) {
                    case 'gap':
                        classesOfCategoryKey = all_1.AllClasses.Grid.gridGap;
                        break;
                    case 'inset':
                        classesOfCategoryKey = all_1.AllClasses.Layout.topRightBottomLeft;
                        break;
                    case 'accessibility':
                        classesOfCategoryKey = all_1.AllClasses.Accessibility.screenReaders;
                        break;
                    case 'transform':
                        classesOfCategoryKey = [];
                        var configHasOtherTransforms = classesCategories.some(function (v) { return Object.keys(all_1.AllClasses.Transforms).indexOf(v) >= 0; });
                        if (configHasOtherTransforms) {
                            var transformsNotInConfig = Object.keys(all_1.AllClasses.Transforms).filter(function (el) { return !classesCategories.includes(el); });
                            ...
                            classesOfCategoryKey = Transforms_1.allTransformClasses;
                        }
                        break;
                    ...
                    case 'space':
                        ...
                        break;
                    default:
                        classesOfCategoryKey = all_1.AllClassesFlat[key];
                        break;
                }
