...
export var defaultThemeConfig = {
    ...
    borderColor: function (theme) { return (__assign(__assign({}, theme('colors')), { default: theme('colors.gray.300', 'currentColor') })); },
    ...
    height: function (theme) { return (__assign(__assign({ auto: 'auto' }, theme('spacing')), { full: '100%', screen: '100vh' })); },
    inset: {
        '0': '0',
        auto: 'auto',
    },
    ...
    margin: function (theme, _a) {
        ...
        return (__assign(__assign({ auto: 'auto' }, theme('spacing')), negative(theme('spacing'))));
    },
    maxHeight: {
        full: '100%',
        screen: '100vh',
    ...
    maxWidth: function (theme, _a) {
        ...
        return (__assign({ none: 'none', xs: '20rem', sm: '24rem', md: '28rem', lg: '32rem', xl: '36rem', '2xl': '42rem', '3xl': '48rem', '4xl': '56rem', '5xl': '64rem', '6xl': '72rem', full: '100%' }, breakpoints(theme('screens'))));
    },
    minHeight: {
        '0': '0',
        full: '100%',
    ...
    translate: function (theme, _a) {
        var negative = _a.negative;
        return (__assign(__assign(__assign({}, theme('spacing')), negative(theme('spacing'))), { '-full': '-100%', '-1/2': '-50%', '1/2': '50%', full: '100%' }));
    },
    skew: {
        '-12': '-12deg',
        '-6': '-6deg',
