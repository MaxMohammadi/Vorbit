var fontFamily = ['font-sans', 'font-serif', 'font-mono'];
var fontSize = [
    'text-xs',
    'text-sm',
    'text-base',
...
var fontSmoothing = ['antialiased', 'subpixel-antialiased'];
var fontStyle = ['italic', 'non-italic'];
var fontWeight = [
    'font-hairline',
    'font-thin',
    'font-light',
...
var listStyleType = ['line-none', 'list-disc', 'list-decimal'];
var listStylePosition = ['list-inside', 'list-outside'];
...
var textAlign = ['text-left', 'text-center', 'text-right', 'text-justify'];
var textColor = [
    'text-transparent',
    'text-black',
    'text-white',
...
var textDecoration = ['underline', 'line-through', 'no-underline'];
var textOpacity = [
    'text-opacity-0',
    'text-opacity-25',
    'text-opacity-50',
...
var textTransform = ['uppercase', 'lowercase', 'capitalize', 'normal-case'];
var verticalAlign = [
    'align-baseline',
    'align-top',
    'align-middle',
...
var wordBreak = ['break-normal', 'break-words', 'break-all', 'truncate'];
