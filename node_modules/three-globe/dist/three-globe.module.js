import { SphereGeometry, Color, LineBasicMaterial, LineSegments, Mesh, MeshPhongMaterial, TextureLoader, BufferGeometry, CylinderGeometry, CylinderBufferGeometry, FaceColors, Geometry, Matrix4, MeshBasicMaterial, MeshLambertMaterial, Object3D, Vector3, AdditiveBlending, CubicBezierCurve3, Curve, Float32BufferAttribute, Line, QuadraticBezierCurve3, ShaderMaterial, TubeBufferGeometry, DoubleSide, Group, NoColors, VertexColors, Font, CircleBufferGeometry, TextBufferGeometry, Vector2 } from 'three';
  ...
  update: function update(state) {
    ...
    threeDigest(state.pathsData, state.scene, {
      createObj: function createObj(path) {
        ...
        var obj = useFatLine ? new Line2(new LineGeometry(), new LineMaterial()) : new THREE$7.Line(new THREE$7.BufferGeometry(), sharedShaderMaterial.clone() // Separate material instance per object to have dedicated uniforms (but shared shaders)
        );
