      ...
      updateObj: function updateObj(obj, d) {
        ...
        threeDigest(h3Idxs.map(function (h3Idx) {
          ...
          createObj: function createObj(_ref) {
            ...
            obj.__hexCenter = h3Js.h3ToGeo(h3Idx);
            obj.__hexGeoJson = h3Js.h3ToGeoBoundary(h3Idx, true); // stitch longitudes at the anti-meridian
          ...
          updateObj: function updateObj(obj) {
            ...
            var applyUpdate = function applyUpdate(td) {
              ...
              obj.geometry = new threeConicPolygonGeometry.ConicPolygonGeometry([geoJson], GLOBE_RADIUS, GLOBE_RADIUS * (1 + alt), false);
            };
  ...
  update: function update(state) {
    ...
    threeDigest(state.pathsData, state.scene, {
      createObj: function createObj(path) {
        ...
        var obj = useFatLine ? new threeFatline.Line2(new threeFatline.LineGeometry(), new threeFatline.LineMaterial()) : new THREE$7.Line(new THREE$7.BufferGeometry(), sharedShaderMaterial.clone() // Separate material instance per object to have dedicated uniforms (but shared shaders)
        );
